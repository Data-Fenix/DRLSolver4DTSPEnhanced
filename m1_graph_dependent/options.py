...
def get_options(args=None):
    ...
    parser.add_argument('--val_dataset', type=str, default=None, help='Path to a .pt file to use as the fixed val/test dataset (same instances across all runs)')
    parser.add_argument('--save_val_dataset', type=str, default=None, help='If set, save the generated val/test dataset to this .pt file path (use once to create a fixed dataset)')
